...
from pyspark.sql.functions import col,split,isnan, when, count, concat, lit, desc, floor, hour, sum
import matplotlib.pyplot as plt
import pandas as pd
import seaborn as sns
from pyspark.sql import SQLContext
from pyspark.sql import DataFrameNaFunctions
from pyspark.ml.feature import Binarizer, OneHotEncoder, VectorAssembler, StringIndexer, VectorIndexer
...
# MAGIC 
# MAGIC Plot the correlation matrix for the temporal features
...
# MAGIC %md ### DEP_DEL15
# MAGIC 
# MAGIC Around 477296 records in the airline data do not have any departure delay status. Also majority of flights do not have a delay.
...
def clean_flights_table(dataframe):
  needed_columns = ["FL_DATE_UTC", "DEP_HOUR_UTC", "FL_DATETIME_UTC", "OP_CARRIER_AIRLINE_ID", "OP_CARRIER_FL_NUM", "ORIGIN", "DEST", "DEP_DEL15", "DEP_HOUR", "Year", "FL_Date", "Day_Of_Week", "Month", "Distance", "number_dep_delay_origin", "number_flights_origin", "number_arr_delay_tail", "number_flights_tail", "percent_dep_delay_origin", "percent_arr_delay_tail"]
